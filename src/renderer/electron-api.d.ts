...
declare global {
  interface Window {
    electronAPI?: {
      ...
      exportHtml: (args: { html: string; suggestedName?: string }) => Promise<{ filePath: string } | null>;
      exportPdf: (args: { html: string; suggestedName?: string }) => Promise<{ filePath: string } | null>;
